...
srv.hosts["10.17.0.1"]=server.RemoteHost("10.17.0.1", "secret", "localhost")
srv.hosts["10.16.0.1"]=server.RemoteHost("10.16.0.1", "secret", "localhost")
srv.hosts["10.15.0.1"]=server.RemoteHost("10.15.0.1", "secret", "localhost")
